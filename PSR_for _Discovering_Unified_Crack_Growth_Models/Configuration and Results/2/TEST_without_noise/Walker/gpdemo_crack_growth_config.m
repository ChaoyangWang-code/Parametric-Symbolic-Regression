...
gp.runcontrol.pop_size = 3000;                     
gp.runcontrol.num_gen = 60;		
gp.runcontrol.stage1 = 25;
gp.runcontrol.stage2 = 50;
%selection
...
gp.fitness.terminate_value = 1e-30;
%
gp.fitness.loss_mode=2.5;    

gp.fitness.diff_model=2.1;
%% 
gp.fitness.loss_MSE_limit=1e-5;
...
%load('FORMAN_test_no_noise_241008.mat')
load('WALKER_test_no_noise_241008.mat')
data_select=false;
selection_num=3;
if data_select
